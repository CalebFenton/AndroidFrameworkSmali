.class public final Lcom/android/okhttp/internal/http/FramedTransport;
...
.method static constructor <clinit>()V
    ...
    #@39
    sput-object v0, Lcom/android/okhttp/internal/http/FramedTransport;->SPDY_3_PROHIBITED_HEADERS:Ljava/util/List;
    ...
    #@8e
    sput-object v0, Lcom/android/okhttp/internal/http/FramedTransport;->HTTP_2_PROHIBITED_HEADERS:Ljava/util/List;
...
.method public constructor <init>(Lcom/android/okhttp/internal/http/HttpEngine;Lcom/android/okhttp/internal/framed/FramedConnection;)V
    .locals 0
    ...
    #@3
    .line 74
    iput-object p1, p0, Lcom/android/okhttp/internal/http/FramedTransport;->httpEngine:Lcom/android/okhttp/internal/http/HttpEngine;

    #@5
    .line 75
    iput-object p2, p0, Lcom/android/okhttp/internal/http/FramedTransport;->framedConnection:Lcom/android/okhttp/internal/framed/FramedConnection;
...
.method private static isProhibitedHeader(Lcom/android/okhttp/Protocol;Lcom/android/okhttp/okio/ByteString;)Z
    ...
    #@4
    .line 225
    sget-object v0, Lcom/android/okhttp/internal/http/FramedTransport;->SPDY_3_PROHIBITED_HEADERS:Ljava/util/List;
    ...
    #@f
    .line 227
    sget-object v0, Lcom/android/okhttp/internal/http/FramedTransport;->HTTP_2_PROHIBITED_HEADERS:Ljava/util/List;
...
.method public static readNameValueBlock(Ljava/util/List;Lcom/android/okhttp/Protocol;)Lcom/android/okhttp/Response$Builder;
    ...
    .line 191
    :cond_3
    invoke-static {p1, v3}, Lcom/android/okhttp/internal/http/FramedTransport;->isProhibitedHeader(Lcom/android/okhttp/Protocol;Lcom/android/okhttp/okio/ByteString;)Z
...
.method public static writeNameValueBlock(Lcom/android/okhttp/Request;Lcom/android/okhttp/Protocol;Ljava/lang/String;)Ljava/util/List;
    ...
    new-instance v10, Lcom/android/okhttp/internal/framed/Header;

    #@11
    sget-object v11, Lcom/android/okhttp/internal/framed/Header;->TARGET_METHOD:Lcom/android/okhttp/okio/ByteString;
    ...
    #@17
    invoke-direct {v10, v11, v12}, Lcom/android/okhttp/internal/framed/Header;-><init>(Lcom/android/okhttp/okio/ByteString;Ljava/lang/String;)V
    ...
    #@1f
    sget-object v11, Lcom/android/okhttp/internal/framed/Header;->TARGET_PATH:Lcom/android/okhttp/okio/ByteString;
    ...
    #@25
    invoke-static {v12}, Lcom/android/okhttp/internal/http/RequestLine;->requestPath(Lcom/android/okhttp/HttpUrl;)Ljava/lang/String;
    ...
    #@33
    invoke-static {v10}, Lcom/android/okhttp/internal/Util;->hostHeader(Lcom/android/okhttp/HttpUrl;)Ljava/lang/String;
    ...
    #@3f
    invoke-direct {v10, v11, p2}, Lcom/android/okhttp/internal/framed/Header;-><init>(Lcom/android/okhttp/okio/ByteString;Ljava/lang/String;)V
    ...
    #@47
    sget-object v11, Lcom/android/okhttp/internal/framed/Header;->TARGET_HOST:Lcom/android/okhttp/okio/ByteString;

    #@49
    invoke-direct {v10, v11, v2}, Lcom/android/okhttp/internal/framed/Header;-><init>(Lcom/android/okhttp/okio/ByteString;Ljava/lang/String;)V
    ...
    #@51
    sget-object v11, Lcom/android/okhttp/internal/framed/Header;->TARGET_SCHEME:Lcom/android/okhttp/okio/ByteString;
    ...
    #@57
    invoke-virtual {v12}, Lcom/android/okhttp/HttpUrl;->scheme()Ljava/lang/String;
    ...
    invoke-static {p1, v5}, Lcom/android/okhttp/internal/http/FramedTransport;->isProhibitedHeader(Lcom/android/okhttp/Protocol;Lcom/android/okhttp/okio/ByteString;)Z
    ...
    #@8e
    sget-object v11, Lcom/android/okhttp/internal/framed/Header;->TARGET_AUTHORITY:Lcom/android/okhttp/okio/ByteString;
    ...
    #@b5
    .line 142
    sget-object v10, Lcom/android/okhttp/internal/framed/Header;->TARGET_AUTHORITY:Lcom/android/okhttp/okio/ByteString;
    ...
    #@d5
    invoke-direct {v10, v5, v9}, Lcom/android/okhttp/internal/framed/Header;-><init>(Lcom/android/okhttp/okio/ByteString;Ljava/lang/String;)V
    ...
    #@e7
    check-cast v10, Lcom/android/okhttp/internal/framed/Header;

    #@e9
    iget-object v10, v10, Lcom/android/okhttp/internal/framed/Header;->name:Lcom/android/okhttp/okio/ByteString;
    ...
    #@f7
    iget-object v10, v10, Lcom/android/okhttp/internal/framed/Header;->value:Lcom/android/okhttp/okio/ByteString;
    ...
    #@fd
    invoke-static {v10, v9}, Lcom/android/okhttp/internal/http/FramedTransport;->joinOnNull(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    #@103
    invoke-direct {v10, v5, v0}, Lcom/android/okhttp/internal/framed/Header;-><init>(Lcom/android/okhttp/okio/ByteString;Ljava/lang/String;)V
...
.method public createRequestBody(Lcom/android/okhttp/Request;J)Lcom/android/okhttp/okio/Sink;
    ...
    .prologue
    .line 79
    iget-object v0, p0, Lcom/android/okhttp/internal/http/FramedTransport;->stream:Lcom/android/okhttp/internal/framed/FramedStream;
...
.method public disconnect(Lcom/android/okhttp/internal/http/HttpEngine;)V
    ...
    #@8
    invoke-virtual {v0, v1}, Lcom/android/okhttp/internal/framed/FramedStream;->close(Lcom/android/okhttp/internal/framed/ErrorCode;)V
...
.method public openResponseBody(Lcom/android/okhttp/Response;)Lcom/android/okhttp/ResponseBody;
    ...
    #@6
    iget-object v2, p0, Lcom/android/okhttp/internal/http/FramedTransport;->stream:Lcom/android/okhttp/internal/framed/FramedStream;

    #@8
    invoke-virtual {v2}, Lcom/android/okhttp/internal/framed/FramedStream;->getSource()Lcom/android/okhttp/okio/Source;
...
.method public readResponseHeaders()Lcom/android/okhttp/Response$Builder;
    ...
    #@6
    iget-object v1, p0, Lcom/android/okhttp/internal/http/FramedTransport;->framedConnection:Lcom/android/okhttp/internal/framed/FramedConnection;
    ...
    #@c
    invoke-static {v0, v1}, Lcom/android/okhttp/internal/http/FramedTransport;->readNameValueBlock(Ljava/util/List;Lcom/android/okhttp/Protocol;)Lcom/android/okhttp/Response$Builder;
...
.method public writeRequestHeaders(Lcom/android/okhttp/Request;)V
    ...
    .prologue
    .line 83
    iget-object v3, p0, Lcom/android/okhttp/internal/http/FramedTransport;->stream:Lcom/android/okhttp/internal/framed/FramedStream;
    ...
    .line 85
    :cond_0
    iget-object v3, p0, Lcom/android/okhttp/internal/http/FramedTransport;->httpEngine:Lcom/android/okhttp/internal/http/HttpEngine;
    ...
    iget-object v3, p0, Lcom/android/okhttp/internal/http/FramedTransport;->framedConnection:Lcom/android/okhttp/internal/framed/FramedConnection;

    #@21
    .line 90
    iget-object v4, p0, Lcom/android/okhttp/internal/http/FramedTransport;->framedConnection:Lcom/android/okhttp/internal/framed/FramedConnection;

    #@23
    invoke-virtual {v4}, Lcom/android/okhttp/internal/framed/FramedConnection;->getProtocol()Lcom/android/okhttp/Protocol;

    #@26
    move-result-object v4

    #@27
    invoke-static {p1, v4, v2}, Lcom/android/okhttp/internal/http/FramedTransport;->writeNameValueBlock(Lcom/android/okhttp/Request;Lcom/android/okhttp/Protocol;Ljava/lang/String;)Ljava/util/List;
    ...
    #@2b
    .line 89
    invoke-virtual {v3, v4, v1, v0}, Lcom/android/okhttp/internal/framed/FramedConnection;->newStream(Ljava/util/List;ZZ)Lcom/android/okhttp/internal/framed/FramedStream;

    #@2e
    move-result-object v3

    #@2f
    iput-object v3, p0, Lcom/android/okhttp/internal/http/FramedTransport;->stream:Lcom/android/okhttp/internal/framed/FramedStream;
    ...
    #@37
    iget-object v4, p0, Lcom/android/okhttp/internal/http/FramedTransport;->httpEngine:Lcom/android/okhttp/internal/http/HttpEngine;
