...
.method private readSettings(Lcom/android/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    #@2
    .line 261
    iget-object v9, p0, Lcom/android/okhttp/internal/framed/Spdy3$Reader;->source:Lcom/android/okhttp/okio/BufferedSource;

    #@4
    invoke-interface {v9}, Lcom/android/okhttp/okio/BufferedSource;->readInt()I
    ...
    #@20
    invoke-static {v9, v10}, Lcom/android/okhttp/internal/framed/Spdy3$Reader;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method public nextFrame(Lcom/android/okhttp/internal/framed/FrameReader$Handler;)Z
    ...
    .line 129
    :try_start_0
    iget-object v11, p0, Lcom/android/okhttp/internal/framed/Spdy3$Reader;->source:Lcom/android/okhttp/okio/BufferedSource;

    #@4
    invoke-interface {v11}, Lcom/android/okhttp/okio/BufferedSource;->readInt()I
    ...
    #@4f
    invoke-interface {v11, v12, v13}, Lcom/android/okhttp/okio/BufferedSource;->skip(J)V
    ...
    #@7f
    invoke-interface {p1, v3, v5, v11, v4}, Lcom/android/okhttp/internal/framed/FrameReader$Handler;->data(ZILcom/android/okhttp/okio/BufferedSource;I)V
