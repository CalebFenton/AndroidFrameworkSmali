...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/content/SyncManager$-void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_LambdaImpl0;,
...
.method synthetic -com_android_server_content_SyncManager_lambda$3(Landroid/accounts/AccountAndUser;IILjava/lang/String;Landroid/os/Bundle;ILandroid/os/Bundle;)V
    .locals 7
...
.method public computeSyncable(Landroid/accounts/Account;ILjava/lang/String;)I
    .locals 10
    .param p1, "account"    # Landroid/accounts/Account;
    .param p2, "userId"    # I
...
.method public scheduleSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;I)V
    ...
    #@7d
    aget-object v41, v3, v2

    #@7f
    .line 814
    .local v41, "runningAccount":Landroid/accounts/AccountAndUser;
    ...
    #@91
    invoke-static {v6, v0, v1}, Lcom/android/internal/util/ArrayUtils;->appendElement(Ljava/lang/Class;[Ljava/lang/Object;Ljava/lang/Object;)[Ljava/lang/Object;

    #@94
    move-result-object v29

    #@95
    check-cast v29, [Landroid/accounts/AccountAndUser;
    ...
    #@9a
    .line 821
    .end local v41    # "runningAccount":Landroid/accounts/AccountAndUser;
    .restart local v29    # "accounts":[Landroid/accounts/AccountAndUser;
    :cond_6
    move-object/from16 v0, p0
    ...
    #@e8
    iget v2, v4, Landroid/accounts/AccountAndUser;->userId:I
    ...
    #@10a
    iget v3, v4, Landroid/accounts/AccountAndUser;->userId:I
    ...
    #@114
    .local v43, "syncAdapter$iterator":Ljava/util/Iterator;
    :goto_4
    ...
    #@148
    .local v30, "authority$iterator":Ljava/util/Iterator;
    :cond_10
    :goto_5
    ...
    iget-object v2, v4, Landroid/accounts/AccountAndUser;->account:Landroid/accounts/Account;
    ...
    #@15a
    invoke-virtual {v0, v2, v3, v7}, Lcom/android/server/content/SyncManager;->computeSyncable(Landroid/accounts/Account;ILjava/lang/String;)I
    ...
    #@164
    .line 885
    iget-object v3, v4, Landroid/accounts/AccountAndUser;->account:Landroid/accounts/Account;
    ...
    #@182
    const-string/jumbo v3, "    Not scheduling sync operation: isSyncable == SYNCABLE_NO_ACCOUNT_ACCESS"
    ...
    #@18f
    .line 898
    .local v8, "finalExtras":Landroid/os/Bundle;
    move-object/from16 v0, v44
    ...
    #@199
    iget-object v2, v0, Lcom/android/server/content/SyncManager;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    #@19f
    invoke-virtual {v2, v0, v1}, Landroid/content/pm/PackageManagerInternal;->wasPackageEverLaunched(Ljava/lang/String;I)Z
    ...
    #@1a9
    iget-object v11, v4, Landroid/accounts/AccountAndUser;->account:Landroid/accounts/Account;
    ...
    #@1ad
    new-instance v2, Lcom/android/server/content/SyncManager$-void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_LambdaImpl0;
    ...
    #@1b7
    invoke-direct/range {v2 .. v9}, Lcom/android/server/content/SyncManager$-void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_LambdaImpl0;-><init>(Lcom/android/server/content/SyncManager;Landroid/accounts/AccountAndUser;IILjava/lang/String;Landroid/os/Bundle;I)V

    #@1ba
    invoke-direct {v14, v2}, Landroid/os/RemoteCallback;-><init>(Landroid/os/RemoteCallback$OnResultListener;)V
    ...
    #@1c1
    invoke-virtual {v10, v11, v0, v1, v14}, Landroid/accounts/AccountManagerInternal;->requestAccountAccess(Landroid/accounts/Account;Ljava/lang/String;ILandroid/os/RemoteCallback;)V
    ...
    #@1c5
    .line 916
    .end local v8    # "finalExtras":Landroid/os/Bundle;
    ...
    #@1e6
    .line 919
    invoke-virtual {v2, v3, v5, v7, v6}, Lcom/android/server/content/SyncStorageEngine;->setIsSyncable(Landroid/accounts/Account;ILjava/lang/String;I)V
    ...
    #@21c
    .line 936
    invoke-virtual {v2, v3, v5, v7}, Lcom/android/server/content/SyncStorageEngine;->getSyncAutomatically(Landroid/accounts/Account;ILjava/lang/String;)Z
    ...
    :cond_18
    new-instance v35, Lcom/android/server/content/SyncStorageEngine$EndPoint;
    ...
    #@260
    invoke-direct {v0, v2, v7, v3}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V

    #@263
    .line 949
    .local v35, "info":Lcom/android/server/content/SyncStorageEngine$EndPoint;
    move-object/from16 v0, p0
    ...
    #@27f
    .line 956
    .local v17, "newExtras":Landroid/os/Bundle;
    ...
    #@2ab
    .line 961
    const-string/jumbo v5, ", flexMillis "
    ...
    #@2ee
    iget-object v10, v4, Landroid/accounts/AccountAndUser;->account:Landroid/accounts/Account;

    #@2f0
    iget v11, v4, Landroid/accounts/AccountAndUser;->userId:I
    ...
    #@2f6
    invoke-direct/range {v9 .. v18}, Lcom/android/server/content/SyncOperation;-><init>(Landroid/accounts/Account;IILjava/lang/String;IILjava/lang/String;Landroid/os/Bundle;Z)V
    ...
    #@2fb
    invoke-direct {v0, v9}, Lcom/android/server/content/SyncManager;->postScheduleSyncMessage(Lcom/android/server/content/SyncOperation;)V
    ...
    #@300
    .line 972
    .end local v17    # "newExtras":Landroid/os/Bundle;
    :cond_1a
    const/4 v2, -0x2
    ...
    #@36f
    invoke-direct/range {v19 .. v28}, Lcom/android/server/content/SyncOperation;-><init>(Landroid/accounts/Account;IILjava/lang/String;IILjava/lang/String;Landroid/os/Bundle;Z)V
    ...
    #@376
    invoke-direct {v0, v1}, Lcom/android/server/content/SyncManager;->postScheduleSyncMessage(Lcom/android/server/content/SyncOperation;)V
    ...
    .end local v12    # "owningUid":I
    .end local v13    # "owningPackage":Ljava/lang/String;
    .end local v18    # "allowParallelSyncs":Z
    .end local v30    # "authority$iterator":Ljava/util/Iterator;
    .end local v32    # "delayUntil":J
    .end local v35    # "info":Lcom/android/server/content/SyncStorageEngine$EndPoint;
    .end local v36    # "isAlwaysSyncable":Z
    .end local v38    # "isSyncable":I
    .end local v43    # "syncAdapter$iterator":Ljava/util/Iterator;
