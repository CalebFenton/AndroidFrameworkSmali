...
.method public static handleOutOfMemory()V
    ...
    #@1
    invoke-static {v0}, Lcom/google/common/StaticUtil;->handleOutOfMemory(Z)V
...
.method private static handleOutOfMemory(Z)V
    ...
    #@1
    .line 433
    sput-object v2, Lcom/google/common/StaticUtil;->emergencyMemory:[B
    ...
    .local v0, "i":I
    :goto_1
    sget-object v2, Lcom/google/common/StaticUtil;->outOfMemoryHandlers:Ljava/util/Vector;
    ...
    #@21
    check-cast v1, Lcom/google/common/OutOfMemoryHandler;

    #@23
    .line 441
    .local v1, "outOfMemoryHandler":Lcom/google/common/OutOfMemoryHandler;
    invoke-interface {v1, p0}, Lcom/google/common/OutOfMemoryHandler;->handleOutOfMemory(Z)V
...
.method public static readPreferenceAsDataInput(Ljava/lang/String;)Ljava/io/DataInput;
    ...
    #@5
    invoke-interface {v1, p0}, Lcom/google/common/io/PersistentStore;->readPreference(Ljava/lang/String;)[B
...
.method public static registerOutOfMemoryHandler(Lcom/google/common/OutOfMemoryHandler;)V
    .locals 1
    .param p0, "handler"    # Lcom/google/common/OutOfMemoryHandler;
...
.method private static savePreferenceAsObject(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    #@63
    invoke-static {v4, v2}, Lcom/google/common/Log;->logQuietThrowable(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_0
    invoke-interface {v3, p0, v5}, Lcom/google/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
    ...
    #@78
    invoke-interface {v3, p0, v4}, Lcom/google/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
