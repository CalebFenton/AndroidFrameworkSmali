...
.field private final mDrawer:Lcom/google/common/graphics/android/AndroidGraphics;
...
.field private mMap:Lcom/google/googlenav/map/Map;

.field private mOverlayBundle:Lcom/google/android/maps/OverlayBundle;

.field private mOverlayRenderer:Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILjava/lang/String;)V
    ...
    #@4
    .line 154
    new-instance v1, Lcom/google/common/graphics/android/AndroidGraphics;

    #@6
    invoke-direct {v1, v2}, Lcom/google/common/graphics/android/AndroidGraphics;-><init>(Landroid/graphics/Canvas;)V

    #@9
    iput-object v1, p0, Lcom/google/android/maps/MapView;->mDrawer:Lcom/google/common/graphics/android/AndroidGraphics;
...
.method private canZoomIn()Z
    ...
    .prologue
    .line 1555
    iget-object v0, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;

    #@2
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->getZoom()Lcom/google/map/Zoom;

    #@5
    move-result-object v0

    #@6
    invoke-virtual {v0}, Lcom/google/map/Zoom;->getZoomLevel()I
...
.method private canZoomOut()Z
    ...
    #@1
    .line 1551
    iget-object v1, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;

    #@3
    invoke-virtual {v1}, Lcom/google/googlenav/map/Map;->getZoom()Lcom/google/map/Zoom;

    #@6
    move-result-object v1

    #@7
    invoke-virtual {v1}, Lcom/google/map/Zoom;->getZoomLevel()I
...
.method public canCoverCenter()Z
    ...
    #@4
    invoke-virtual {v1}, Lcom/google/googlenav/map/Map;->getCenterPoint()Lcom/google/map/MapPoint;
    ...
    #@9
    invoke-virtual {v0, v1, v2}, Lcom/google/googlenav/map/Map;->canCover(Lcom/google/map/MapPoint;Z)Z
...
.method cleanupMapReferences(Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
    .locals 1
    .param p1, "dispatcher"    # Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    #@2
    invoke-virtual {p1, v0}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->removeDataRequestListener(Lcom/google/googlenav/datarequest/DataRequestListener;)V
...
.method drawMap(Landroid/graphics/Canvas;Z)Z
    ...
    .prologue
    .line 1091
    iget-object v0, p0, Lcom/google/android/maps/MapView;->mDrawer:Lcom/google/common/graphics/android/AndroidGraphics;

    #@2
    invoke-virtual {v0, p1}, Lcom/google/common/graphics/android/AndroidGraphics;->setCanvas(Landroid/graphics/Canvas;)V
    ...
    #@8
    iget-object v1, p0, Lcom/google/android/maps/MapView;->mDrawer:Lcom/google/common/graphics/android/AndroidGraphics;
    ...
    #@15
    .line 1093
    invoke-virtual/range {v0 .. v6}, Lcom/google/googlenav/map/Map;->drawMap(Lcom/google/common/graphics/GoogleGraphics;ZZZZZ)Z
...
.method public getLatitudeSpan()I
    ...
    #@2
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->getLatitudeSpan()I
...
.method public getLongitudeSpan()I
    ...
    #@1
    .line 1275
    iget-object v8, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;

    #@3
    invoke-virtual {v8}, Lcom/google/googlenav/map/Map;->getMapState()Lcom/google/map/MapState;
    ...
    #@7
    .line 1276
    .local v3, "mapState":Lcom/google/map/MapState;
    invoke-virtual {v3}, Lcom/google/map/MapState;->getCenterPoint()Lcom/google/map/MapPoint;
    ...
    #@b
    .line 1277
    .local v4, "point":Lcom/google/map/MapPoint;
    invoke-virtual {v3}, Lcom/google/map/MapState;->getZoom()Lcom/google/map/Zoom;
    ...
    #@f
    .line 1278
    .local v7, "zoom":Lcom/google/map/Zoom;
    iget-object v8, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;

    #@11
    invoke-virtual {v8}, Lcom/google/googlenav/map/Map;->getWidth()I
    ...
    #@23
    invoke-virtual {v4, v8, v10, v7}, Lcom/google/map/MapPoint;->pixelOffset(IILcom/google/map/Zoom;)Lcom/google/map/MapPoint;
    ...
    #@27
    .line 1288
    .local v2, "left":Lcom/google/map/MapPoint;
    invoke-virtual {v4, v1, v10, v7}, Lcom/google/map/MapPoint;->pixelOffset(IILcom/google/map/Zoom;)Lcom/google/map/MapPoint;
    ...
    #@2b
    .line 1289
    .local v5, "right":Lcom/google/map/MapPoint;
    invoke-virtual {v5}, Lcom/google/map/MapPoint;->getLongitude()I

    #@2e
    move-result v8

    #@2f
    invoke-virtual {v2}, Lcom/google/map/MapPoint;->getLongitude()I
...
.method public getMapCenter()Lcom/google/android/maps/GeoPoint;
    ...
    #@8
    invoke-direct {v0, v1}, Lcom/google/android/maps/GeoPoint;-><init>(Lcom/google/map/MapPoint;)V
...
.method public getMaxZoomLevel()I
    ...
    #@8
    invoke-virtual {v0, v1}, Lcom/google/googlenav/map/Map;->getMaxMapZoomForPoint(Lcom/google/map/MapPoint;)I
...
.method getZoom()Lcom/google/map/Zoom;
    .locals 1
...
.method public isSatellite()Z
    ...
    #@2
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->isSatellite()Z
...
.method public isTraffic()Z
    ...
    .prologue
    .line 1187
    iget-object v0, p0, Lcom/google/android/maps/MapView;->mOverlayRenderer:Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;

    #@2
    invoke-virtual {v0}, Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;->isShowTraffic()Z
...
.method protected final onMeasure(II)V
    ...
    #@52
    .line 592
    iget-object v4, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;
    ...
    #@5c
    invoke-virtual {v4, v5, v6}, Lcom/google/googlenav/map/Map;->resize(II)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    #@9
    invoke-virtual {v1}, Lcom/google/map/MapPoint;->getLatitude()I
    ...
    #@18
    invoke-virtual {v1}, Lcom/google/map/MapPoint;->getLongitude()I
...
.method protected onSizeChanged(IIII)V
    ...
    #@2
    invoke-virtual {v4, p1, p2}, Lcom/google/googlenav/map/Map;->resize(II)V
...
.method public onTrackballEvent(Landroid/view/MotionEvent;)Z
    ...
    #@3d
    iget-object v3, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;

    #@3f
    invoke-virtual {v3}, Lcom/google/googlenav/map/Map;->getCenterPoint()Lcom/google/map/MapPoint;

    #@42
    move-result-object v3

    #@43
    invoke-direct {v2, v3}, Lcom/google/android/maps/GeoPoint;-><init>(Lcom/google/map/MapPoint;)V
...
.method public preLoad()V
    ...
    #@8
    invoke-virtual {v0, v1}, Lcom/google/googlenav/map/Map;->preLoad(Lcom/google/map/MapPoint;)V
...
.method restoreMapReferences(Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
    .locals 2
    .param p1, "dispatcher"    # Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    #@2
    invoke-virtual {p1, v0}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->addDataRequestListener(Lcom/google/googlenav/datarequest/DataRequestListener;)V
    ...
    #@7
    iget-object v1, p0, Lcom/google/android/maps/MapView;->mOverlayRenderer:Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;

    #@9
    invoke-virtual {v0, v1}, Lcom/google/googlenav/map/Map;->setTileOverlayRenderer(Lcom/google/googlenav/map/TileOverlayRenderer;)V
...
.method public setSatellite(Z)V
    ...
    #@c
    invoke-virtual {v0, v1}, Lcom/google/googlenav/map/Map;->setMapMode(I)V
...
.method public setTraffic(Z)V
    ...
    #@8
    invoke-virtual {v0, p1}, Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;->setShowTraffic(Z)V
...
.method setup(Lcom/google/googlenav/map/Map;Lcom/google/googlenav/map/TrafficService;Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
    .locals 3
    .param p1, "map"    # Lcom/google/googlenav/map/Map;
    .param p2, "traffic"    # Lcom/google/googlenav/map/TrafficService;
    .param p3, "dispatcher"    # Lcom/google/googlenav/datarequest/DataRequestDispatcher;

    #@0
    .prologue
    .line 310
    iput-object p1, p0, Lcom/google/android/maps/MapView;->mMap:Lcom/google/googlenav/map/Map;
    ...
    #@4
    invoke-direct {v0, p1}, Lcom/google/android/maps/PixelConverter;-><init>(Lcom/google/googlenav/map/Map;)V
    ...
    #@14
    invoke-direct {v0, v1, p0}, Lcom/google/android/maps/MapController;-><init>(Lcom/google/googlenav/map/Map;Lcom/google/android/maps/MapView;)V
    ...
    #@34
    .line 324
    new-instance v0, Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;

    #@36
    invoke-direct {v0}, Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;-><init>()V

    #@39
    iput-object v0, p0, Lcom/google/android/maps/MapView;->mOverlayRenderer:Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;
    ...
    #@3d
    invoke-virtual {v0, p2}, Lcom/google/googlenav/ui/android/AndroidTileOverlayRenderer;->setTrafficService(Lcom/google/googlenav/map/TrafficService;)V

    #@40
    .line 327
    invoke-virtual {p0, p3}, Lcom/google/android/maps/MapView;->restoreMapReferences(Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
