...
.method private static initFromResourceBundle()V
    ...
    #@109
    .line 272
    .local v39, "typeDataMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/locale/KeyTypeData$Type;>;"
    const/16 v28, 0x0

    #@10b
    .line 275
    .local v28, "specialTypeSet":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/impl/locale/KeyTypeData$SpecialType;>;"
    const/16 v42, 0x0
    ...
    #@11b
    .line 284
    .end local v28    # "specialTypeSet":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/impl/locale/KeyTypeData$SpecialType;>;"
    ...
    .restart local v28    # "specialTypeSet":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/impl/locale/KeyTypeData$SpecialType;>;"
    ...
    #@208
    .line 350
    .local v29, "specialTypes":Ljava/util/EnumSet;, "Ljava/util/EnumSet<Landroid/icu/impl/locale/KeyTypeData$SpecialType;>;"
    if-eqz v28, :cond_11
    ...
    #@20e
    .line 354
    .end local v29    # "specialTypes":Ljava/util/EnumSet;, "Ljava/util/EnumSet<Landroid/icu/impl/locale/KeyTypeData$SpecialType;>;"
    :cond_11
    ...
    .end local v39    # "typeDataMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/locale/KeyTypeData$Type;>;"
    :cond_12
    return-void
