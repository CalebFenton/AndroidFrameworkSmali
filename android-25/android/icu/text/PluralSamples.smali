...
.method public constructor <init>(Landroid/icu/text/PluralRules;)V
    ...
    #@72
    .line 84
    .local v26, "sampleFractionMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;>;"
    ...
    #@77
    .line 86
    .local v23, "mentioned":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;"
    ...
    #@134
    .line 113
    .local v22, "list":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;"
    if-nez v22, :cond_4
    ...
    #@138
    .end local v22    # "list":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;"
    invoke-direct/range {v22 .. v22}, Ljava/util/LinkedHashSet;-><init>()V

    #@13b
    .line 115
    .restart local v22    # "list":Ljava/util/Set;, "Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;"
    move-object/from16 v0, v26
    ...
    #@22f
    .line 138
    .end local v14    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/Set<Landroid/icu/text/PluralRules$FixedDecimal;>;>;"
    :cond_d
    move-object/from16 v0, p0
