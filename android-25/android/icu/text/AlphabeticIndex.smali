...
.method private createBucketList()Landroid/icu/text/AlphabeticIndex$BucketList;
    ...
    #@15e
    .line 965
    .end local v7    # "asciiBuckets":[Landroid/icu/text/AlphabeticIndex$Bucket;, "[Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v8    # "bucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v10    # "bucketList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;>;"
    ...
    .end local v16    # "i":I
    .end local v20    # "pinyinBuckets":[Landroid/icu/text/AlphabeticIndex$Bucket;, "[Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v22    # "scriptIndex":I
    .end local v23    # "scriptUpperBoundary":Ljava/lang/String;
    .end local v24    # "singleBucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    ...
    #@162
    .line 995
    .restart local v7    # "asciiBuckets":[Landroid/icu/text/AlphabeticIndex$Bucket;, "[Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .restart local v10    # "bucketList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;>;"
    ...
    .restart local v20    # "pinyinBuckets":[Landroid/icu/text/AlphabeticIndex$Bucket;, "[Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    ...
    .restart local v24    # "singleBucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    :cond_7
    new-instance v8, Landroid/icu/text/AlphabeticIndex$Bucket;
...
.method private initBuckets()V
    ...
    .line 758
    .end local v3    # "nextBucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v4    # "r":Landroid/icu/text/AlphabeticIndex$Record;, "Landroid/icu/text/AlphabeticIndex$Record<TV;>;"
    ...
    .end local v3    # "nextBucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v6    # "upperBoundary":Ljava/lang/String;
    .restart local v4    # "r":Landroid/icu/text/AlphabeticIndex$Record;, "Landroid/icu/text/AlphabeticIndex$Record<TV;>;"
    ...
    #@93
    .line 731
    .end local v0    # "bucket":Landroid/icu/text/AlphabeticIndex$Bucket;, "Landroid/icu/text/AlphabeticIndex$Bucket<TV;>;"
    .end local v4    # "r":Landroid/icu/text/AlphabeticIndex$Record;, "Landroid/icu/text/AlphabeticIndex$Record<TV;>;"
    :cond_8
    return-void
.end method
...
.method public buildImmutableIndex()Landroid/icu/text/AlphabeticIndex$ImmutableIndex;
    ...
    #@21
    .line 601
    .end local v0    # "immutableBucketList":Landroid/icu/text/AlphabeticIndex$BucketList;, "Landroid/icu/text/AlphabeticIndex$BucketList<TV;>;"
    :cond_2
    invoke-direct {p0}, Landroid/icu/text/AlphabeticIndex;->createBucketList()Landroid/icu/text/AlphabeticIndex$BucketList;
