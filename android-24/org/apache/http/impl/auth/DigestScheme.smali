...
.method private createDigestHeader(Lorg/apache/http/auth/Credentials;Ljava/lang/String;)Lorg/apache/http/Header;
    ...
    #@4
    invoke-direct {v2, v13}, Lorg/apache/http/util/CharArrayBuffer;-><init>(I)V
    ...
    #@d
    .line 392
    const-string/jumbo v13, "Proxy-Authorization"

    #@10
    invoke-virtual {v2, v13}, Lorg/apache/http/util/CharArrayBuffer;->append(Ljava/lang/String;)V
    ...
    #@1e
    invoke-virtual {v0, v13}, Lorg/apache/http/impl/auth/RFC2617Scheme;->getParameter(Ljava/lang/String;)Ljava/lang/String;
    ...
    #@3d
    .line 402
    .local v6, "opaque":Ljava/lang/String;
    ...
    #@67
    invoke-direct {v13, v14, v9}, Lorg/apache/http/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    #@aa
    const-string/jumbo v15, "00000001"
    ...
    #@c9
    invoke-direct {v13, v14, v1}, Lorg/apache/http/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    #@e9
    .line 428
    .local v7, "param":Lorg/apache/http/message/BasicNameValuePair;
    if-lez v3, :cond_3
    ...
    .line 433
    :goto_2
    sget-object v14, Lorg/apache/http/message/BasicHeaderValueFormatter;->DEFAULT:Lorg/apache/http/message/BasicHeaderValueFormatter;
    ...
    .line 433
    :goto_3
    invoke-virtual {v14, v2, v7, v13}, Lorg/apache/http/message/BasicHeaderValueFormatter;->formatNameValuePair(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/NameValuePair;Z)Lorg/apache/http/util/CharArrayBuffer;
    ...
    .end local v6    # "opaque":Ljava/lang/String;
    .end local v7    # "param":Lorg/apache/http/message/BasicNameValuePair;
    ...
    .restart local v6    # "opaque":Ljava/lang/String;
    .restart local v7    # "param":Lorg/apache/http/message/BasicNameValuePair;
    ...
    .end local v7    # "param":Lorg/apache/http/message/BasicNameValuePair;
    :cond_7
    new-instance v13, Lorg/apache/http/message/BufferedHeader;

    #@122
    invoke-direct {v13, v2}, Lorg/apache/http/message/BufferedHeader;-><init>(Lorg/apache/http/util/CharArrayBuffer;)V
