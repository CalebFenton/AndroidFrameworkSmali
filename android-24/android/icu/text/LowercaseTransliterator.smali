...
.method static synthetic -get0(Landroid/icu/text/LowercaseTransliterator;)Landroid/icu/util/ULocale;
    ...
    #@0
    iget-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->locale:Landroid/icu/util/ULocale;
...
.method public constructor <init>(Landroid/icu/util/ULocale;)V
    ...
    #@8
    .line 116
    iput-object v2, p0, Landroid/icu/text/LowercaseTransliterator;->sourceTargetUtility:Landroid/icu/text/SourceTargetUtility;
    ...
    #@e
    iput-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->csp:Landroid/icu/impl/UCaseProps;
    ...
    #@15
    iput-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->iter:Landroid/icu/text/ReplaceableContextIterator;
    ...
    #@1c
    iput-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->result:Ljava/lang/StringBuilder;
    ...
    #@21
    iput-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->locCache:[I

    #@23
    .line 58
    iget-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->locCache:[I
...
.method static register()V
    ...
    #@3
    new-instance v1, Landroid/icu/text/LowercaseTransliterator$1;

    #@5
    invoke-direct {v1}, Landroid/icu/text/LowercaseTransliterator$1;-><init>()V
...
.method protected declared-synchronized handleTransliterate(Landroid/icu/text/Replaceable;Landroid/icu/text/Transliterator$Position;Z)V
    ...
    #@14
    .line 75
    iget-object v0, p0, Landroid/icu/text/LowercaseTransliterator;->result:Ljava/lang/StringBuilder;
    ...
    #@3f
    iget-object v4, p0, Landroid/icu/text/LowercaseTransliterator;->locale:Landroid/icu/util/ULocale;

    #@41
    iget-object v5, p0, Landroid/icu/text/LowercaseTransliterator;->locCache:[I
    ...
    #@63
    iget-object v2, p0, Landroid/icu/text/LowercaseTransliterator;->result:Ljava/lang/StringBuilder;
