...
.method private getVisibleIDMap()Ljava/util/Map;
    ...
    #@1
    .line 589
    .local v1, "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    iget-object v4, p0, Landroid/icu/impl/ICUService;->idref:Ljava/lang/ref/SoftReference;

    #@3
    .line 590
    .local v4, "ref":Ljava/lang/ref/SoftReference;, "Ljava/lang/ref/SoftReference<Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;>;"
    if-eqz v4, :cond_2
    ...
    #@9
    .end local v1    # "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    ...
    .line 593
    .end local v1    # "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    .local v2, "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    :goto_0
    if-nez v2, :cond_4
    ...
    #@21
    .line 601
    .end local v2    # "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    .restart local v1    # "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    :try_start_2
    ...
    #@2d
    .line 602
    .local v3, "lIter":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Landroid/icu/impl/ICUService$Factory;>;"
    :goto_1
    ...
    .end local v3    # "lIter":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Landroid/icu/impl/ICUService$Factory;>;"
    :catchall_0
    move-exception v5
    ...
    #@47
    .line 606
    .restart local v3    # "lIter":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Landroid/icu/impl/ICUService$Factory;>;"
    :cond_1
    :try_start_4
    ...
    #@59
    .restart local v2    # "idcache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    goto :goto_0
...
.method public getDisplayNames(Landroid/icu/util/ULocale;Ljava/util/Comparator;Ljava/lang/String;)Ljava/util/SortedMap;
    ...
    #@4a
    .line 710
    .end local v3    # "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    ...
    #@4d
    .line 723
    .restart local v5    # "ei":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;>;"
    .restart local v9    # "m":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;>;"
    :cond_1
    :try_start_2
...
.method public getKey(Landroid/icu/impl/ICUService$Key;[Ljava/lang/String;Landroid/icu/impl/ICUService$Factory;)Ljava/lang/Object;
    ...
    #@55
    .line 406
    .local v7, "cref":Ljava/lang/ref/SoftReference;, "Ljava/lang/ref/SoftReference<Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$CacheEntry;>;>;"
    if-eqz v7, :cond_3
    ...
    #@be
    .end local v7    # "cref":Ljava/lang/ref/SoftReference;, "Ljava/lang/ref/SoftReference<Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$CacheEntry;>;>;"
    invoke-direct {v7, v4}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    #@c1
    .line 419
    .end local v4    # "cache":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$CacheEntry;>;"
    .restart local v7    # "cref":Ljava/lang/ref/SoftReference;, "Ljava/lang/ref/SoftReference<Ljava/util/Map<Ljava/lang/String;Landroid/icu/impl/ICUService$CacheEntry;>;>;"
    :cond_5
    const/4 v8, 0x0
