...
.method public getSession([B)Ljavax/net/ssl/SSLSession;
    ...
    #@25
    .line 293
    instance-of v2, v1, Lcom/android/org/conscrypt/OpenSSLSessionImpl;
...
.method toBytes(Ljavax/net/ssl/SSLSession;)[B
    ...
    #@50
    const-string/jumbo v10, "Failed to convert saved SSL Session: "
...
.method toSession([BLjava/lang/String;I)Lcom/android/org/conscrypt/OpenSSLSessionImpl;
    .locals 14
    .param p1, "data"    # [B
...
.method protected wrapSSLSessionIfNeeded(Ljavax/net/ssl/SSLSession;)Ljavax/net/ssl/SSLSession;
    ...
    .prologue
    .line 275
    instance-of v0, p1, Lcom/android/org/conscrypt/OpenSSLSessionImpl;
    ...
    #@4
    .line 276
    check-cast p1, Lcom/android/org/conscrypt/OpenSSLSessionImpl;

    #@6
    .end local p1    # "session":Ljavax/net/ssl/SSLSession;
    invoke-static {p1}, Lcom/android/org/conscrypt/Platform;->wrapSSLSession(Lcom/android/org/conscrypt/OpenSSLSessionImpl;)Ljavax/net/ssl/SSLSession;
    ...
    #@b
    .line 278
    .restart local p1    # "session":Ljavax/net/ssl/SSLSession;
    :cond_0
    return-object p1
.end method
