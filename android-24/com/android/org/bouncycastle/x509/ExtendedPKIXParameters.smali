...
.method protected setParams(Ljava/security/cert/PKIXParameters;)V
    ...
    #@5
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setDate(Ljava/util/Date;)V
    ...
    #@c
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setCertPathCheckers(Ljava/util/List;)V
    ...
    #@1a
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setAnyPolicyInhibited(Z)V
    ...
    #@21
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setExplicitPolicyRequired(Z)V
    ...
    #@28
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setPolicyMappingInhibited(Z)V
    ...
    #@36
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setInitialPolicies(Ljava/util/Set;)V
    ...
    #@3d
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setPolicyQualifiersRejected(Z)V
    ...
    #@44
    invoke-virtual {p0, v3}, Ljava/security/cert/PKIXParameters;->setSigProvider(Ljava/lang/String;)V
