...
.method protected checkPreviousNetworkSuccess()V
    ...
    .prologue
    .line 58
    iget-object v1, p0, Lcom/google/common/io/BaseConnectionFactory;->store:Lcom/google/common/io/PersistentStore;

    #@2
    iget-object v2, p0, Lcom/google/common/io/BaseConnectionFactory;->netAvailablePrefName:Ljava/lang/String;

    #@4
    invoke-interface {v1, v2}, Lcom/google/common/io/PersistentStore;->readPreference(Ljava/lang/String;)[B
    ...
    #@b
    :goto_0
    invoke-direct {p0, v1}, Lcom/google/common/io/BaseConnectionFactory;->setNetworkWorked(Z)V
