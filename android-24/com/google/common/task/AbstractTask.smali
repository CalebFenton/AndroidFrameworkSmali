...
.method public constructor <init>(Lcom/google/common/task/TaskRunner;Ljava/lang/Runnable;Ljava/lang/String;)V
    .locals 2
    .param p1, "runner"    # Lcom/google/common/task/TaskRunner;
...
.method protected getTasks()[Lcom/google/common/task/AbstractTask;
    ...
    #@1
    .line 235
    .local v0, "taskArray":[Lcom/google/common/task/AbstractTask;
    monitor-enter p0
    ...
    #@10
    new-array v0, v1, [Lcom/google/common/task/AbstractTask;
    ...
    #@18
    .line 242
    .end local v0    # "taskArray":[Lcom/google/common/task/AbstractTask;
    :catchall_0
    move-exception v1
...
.method runInternal()V
    ...
    .line 322
    :goto_0
    iget-object v4, p0, Lcom/google/common/task/AbstractTask;->runCounterLock:Ljava/lang/Object;
    ...
    .line 323
    :try_start_1
    iget v3, p0, Lcom/google/common/task/AbstractTask;->runCounter:I

    #@8
    add-int/lit8 v3, v3, 0x1

    #@a
    iput v3, p0, Lcom/google/common/task/AbstractTask;->runCounter:I

    #@c
    .line 324
    iget-object v3, p0, Lcom/google/common/task/AbstractTask;->runCounterLock:Ljava/lang/Object;
    ...
    #@16
    .local v1, "taskArray":[Lcom/google/common/task/AbstractTask;
    const/4 v0, 0x0
    ...
    .line 320
    .end local v0    # "i":I
    .end local v1    # "taskArray":[Lcom/google/common/task/AbstractTask;
    :catch_0
    move-exception v2
    ...
    .restart local v1    # "taskArray":[Lcom/google/common/task/AbstractTask;
    :cond_0
    aget-object v3, v1, v0

    #@25
    invoke-virtual {v3}, Lcom/google/common/task/AbstractTask;->schedule()V
