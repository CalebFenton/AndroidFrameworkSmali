...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/common/Log$OnScreenPrinter;,
...
.field private static onScreenPrinter:Lcom/google/common/Log$OnScreenPrinter;
...
.method public static addEvent(SLjava/lang/String;Ljava/lang/String;)Z
    ...
    #@8
    .local v9, "store":Lcom/google/common/io/PersistentStore;
    const-string/jumbo v12, "EVENT_LOG"

    #@b
    .line 617
    invoke-interface {v9, v12}, Lcom/google/common/io/PersistentStore;->readPreference(Ljava/lang/String;)[B
    ...
    #@13
    .line 626
    sget-object v12, Lcom/google/common/Log;->logSaver:Lcom/google/common/Log$LogSaver;
    ...
    #@3f
    .line 657
    sget-wide v12, Lcom/google/common/Log;->lastEventTimeMillis:J
    ...
    #@67
    invoke-interface {v12, v13, v14}, Lcom/google/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z

    #@6a
    .line 665
    sput-wide v10, Lcom/google/common/Log;->lastEventTimeMillis:J
    :try_end_0
    ...
    .line 622
    :cond_4
    invoke-static {v10, v11}, Lcom/google/common/Log;->resetPersistentEventLog(J)V
    ...
    #@8a
    invoke-static {v12, v13, v10, v11}, Lcom/google/common/Log;->uploadEventLog(ZLjava/lang/Object;J)Ljava/lang/Object;
...
.method public static createEventTuple([Ljava/lang/String;)Ljava/lang/String;
    ...
    #@2f
    .line 740
    invoke-static {v3, v4, v1}, Lcom/google/common/util/text/TextUtil;->replace(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuffer;)I
...
.method public static logToScreen(Ljava/lang/String;)V
    ...
    .prologue
    .line 1001
    sget-object v0, Lcom/google/common/Log;->onScreenPrinter:Lcom/google/common/Log$OnScreenPrinter;
    ...
    #@7
    invoke-interface {v0, p0}, Lcom/google/common/Log$OnScreenPrinter;->printToScreen(Ljava/lang/String;)V
...
.method private static resetPersistentEventLog(J)V
    ...
    #@3e
    invoke-interface {v4, v5, v6}, Lcom/google/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
...
.method public static setLogSaver(Lcom/google/common/Log$LogSaver;)V
    .locals 0
    .param p0, "logSaver"    # Lcom/google/common/Log$LogSaver;
...
.method private static uploadEventLog(ZLjava/lang/Object;J)Ljava/lang/Object;
    ...
    #@7
    invoke-interface {v2, v3}, Lcom/google/common/io/PersistentStore;->readPreference(Ljava/lang/String;)[B
    ...
    .line 795
    .local v0, "logBytes":[B
    sget-object v2, Lcom/google/common/Log;->logSaver:Lcom/google/common/Log$LogSaver;

    #@d
    invoke-interface {v2, p0, p1, v0}, Lcom/google/common/Log$LogSaver;->uploadEventLog(ZLjava/lang/Object;[B)Ljava/lang/Object;
