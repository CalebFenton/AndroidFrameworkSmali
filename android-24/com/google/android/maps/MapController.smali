...
# static fields
.field private static final synthetic -com-google-android-maps-MapController$HorizPanStateSwitchesValues:[I

.field private static final synthetic -com-google-android-maps-MapController$VertPanStateSwitchesValues:[I
...
.field private final mMap:Lcom/google/googlenav/map/Map;
...
.field private mPanPoint:Lcom/google/map/MapPoint;
...
# direct methods
.method private static synthetic -getcom-google-android-maps-MapController$HorizPanStateSwitchesValues()[I
    .locals 3

    #@0
    sget-object v0, Lcom/google/android/maps/MapController;->-com-google-android-maps-MapController$HorizPanStateSwitchesValues:[I
    ...
    #@29
    :goto_2
    sput-object v0, Lcom/google/android/maps/MapController;->-com-google-android-maps-MapController$HorizPanStateSwitchesValues:[I
...
.method private static synthetic -getcom-google-android-maps-MapController$VertPanStateSwitchesValues()[I
    .locals 3

    #@0
    sget-object v0, Lcom/google/android/maps/MapController;->-com-google-android-maps-MapController$VertPanStateSwitchesValues:[I
    ...
    #@29
    :goto_2
    sput-object v0, Lcom/google/android/maps/MapController;->-com-google-android-maps-MapController$VertPanStateSwitchesValues:[I
...
.method constructor <init>(Lcom/google/googlenav/map/Map;Lcom/google/android/maps/MapView;)V
    .locals 5
    ...
    #@23
    .line 52
    iput-object v1, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;
    ...
    #@31
    .line 76
    iput-object p1, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;
...
.method private animateTo(Lcom/google/android/maps/GeoPoint;Ljava/lang/Runnable;Landroid/os/Message;)V
    ...
    #@8
    .line 232
    invoke-virtual {p1}, Lcom/google/android/maps/GeoPoint;->getMapPoint()Lcom/google/map/MapPoint;
    ...
    #@c
    .line 233
    .local v4, "mapPoint":Lcom/google/map/MapPoint;
    invoke-virtual {p0, v10}, Lcom/google/android/maps/MapController;->stopAnimation(Z)V

    #@f
    .line 234
    iget-object v5, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;

    #@11
    invoke-virtual {v5, v4}, Lcom/google/googlenav/map/Map;->preLoad(Lcom/google/map/MapPoint;)V

    #@14
    .line 235
    iput-object v4, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;
    ...
    #@18
    invoke-virtual {v5}, Lcom/google/googlenav/map/Map;->getCenterPoint()Lcom/google/map/MapPoint;
    ...
    #@1c
    .line 238
    .local v1, "center":Lcom/google/map/MapPoint;
    iget-object v5, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;

    #@1e
    invoke-virtual {v5}, Lcom/google/googlenav/map/Map;->getZoom()Lcom/google/map/Zoom;

    #@21
    move-result-object v5

    #@22
    invoke-virtual {v4, v1, v5}, Lcom/google/map/MapPoint;->pixelDistanceSquared(Lcom/google/map/MapPoint;Lcom/google/map/Zoom;)J
    ...
    #@41
    invoke-virtual {v4}, Lcom/google/map/MapPoint;->getLatitude()I
    ...
    #@4d
    invoke-virtual {v4}, Lcom/google/map/MapPoint;->getLongitude()I
...
.method private centerMapToInternal(Lcom/google/map/MapPoint;)V
    .locals 1
    .param p1, "mapPoint"    # Lcom/google/map/MapPoint;

    #@0
    .prologue
    .line 352
    iget-object v0, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;

    #@2
    invoke-virtual {v0, p1}, Lcom/google/googlenav/map/Map;->setCenterPoint(Lcom/google/map/MapPoint;)V
...
.method getDeltas()[I
    ...
    #@5
    .line 96
    invoke-static {}, Lcom/google/android/maps/MapController;->-getcom-google-android-maps-MapController$HorizPanStateSwitchesValues()[I
    ...
    .line 106
    :goto_0
    invoke-static {}, Lcom/google/android/maps/MapController;->-getcom-google-android-maps-MapController$VertPanStateSwitchesValues()[I
...
.method public scrollBy(II)V
    ...
    #@4
    .line 304
    iget-object v1, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;
    ...
    #@a
    .line 305
    iget-object v2, p0, Lcom/google/android/maps/MapController;->mMap:Lcom/google/googlenav/map/Map;

    #@c
    invoke-virtual {v2}, Lcom/google/googlenav/map/Map;->getZoom()Lcom/google/map/Zoom;
    ...
    #@10
    .line 304
    invoke-virtual {v1, p1, p2, v2}, Lcom/google/map/MapPoint;->pixelOffset(IILcom/google/map/Zoom;)Lcom/google/map/MapPoint;
    ...
    #@14
    .line 306
    .local v0, "newCenter":Lcom/google/map/MapPoint;
    invoke-direct {p0, v0}, Lcom/google/android/maps/MapController;->centerMapToInternal(Lcom/google/map/MapPoint;)V
...
.method public setZoom(I)I
    ...
    #@b
    .line 395
    invoke-static {p1}, Lcom/google/map/Zoom;->getZoom(I)Lcom/google/map/Zoom;

    #@e
    move-result-object v0

    #@f
    invoke-virtual {p0, v0}, Lcom/google/android/maps/MapController;->zoomTo(Lcom/google/map/Zoom;)V
...
.method stepAnimation(J)Z
    ...
    #@4f
    .line 275
    invoke-direct {v0, v3, v4}, Lcom/google/map/MapPoint;-><init>(II)V
    ...
    #@56
    .line 280
    .end local v0    # "newCenter":Lcom/google/map/MapPoint;
    :cond_2
    iget-object v3, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;

    #@58
    invoke-direct {p0, v3}, Lcom/google/android/maps/MapController;->centerMapToInternal(Lcom/google/map/MapPoint;)V

    #@5b
    .line 281
    iput-object v6, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;
...
.method public stopAnimation(Z)V
    ...
    .line 368
    :try_start_0
    iget-object v0, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;
    ...
    #@12
    .line 372
    iput-object v2, p0, Lcom/google/android/maps/MapController;->mPanPoint:Lcom/google/map/MapPoint;
...
.method zoomTo(Lcom/google/map/Zoom;)V
    .locals 1
    ...
    #@2
    invoke-virtual {v0, p1}, Lcom/google/googlenav/map/Map;->setZoom(Lcom/google/map/Zoom;)V
...
.method public zoomToSpan(II)V
    ...
    #@6
    invoke-virtual {v0, p1, p2}, Lcom/google/googlenav/map/Map;->zoomToSpan(II)V
