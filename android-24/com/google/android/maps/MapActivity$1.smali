...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #@33
    invoke-static {v5}, Lcom/google/android/maps/MapActivity;->-get1(Lcom/google/android/maps/MapActivity;)Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    #@3f
    invoke-virtual {v5}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->stop()V
    ...
    #@4c
    invoke-virtual {v5}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->start()V
    ...
    #@51
    invoke-static {v5}, Lcom/google/android/maps/MapActivity;->-get0(Lcom/google/android/maps/MapActivity;)Lcom/google/common/android/AndroidConfig;

    #@54
    move-result-object v5

    #@55
    invoke-virtual {v5}, Lcom/google/common/android/AndroidConfig;->getConnectionFactory()Lcom/google/common/io/android/AndroidHttpConnectionFactory;
    ...
    #@59
    .line 372
    .local v2, "factory":Lcom/google/common/io/android/AndroidHttpConnectionFactory;
    if-nez v2, :cond_2
    ...
    .line 376
    :cond_2
    invoke-virtual {v2}, Lcom/google/common/io/android/AndroidHttpConnectionFactory;->getClient()Lcom/google/common/io/android/GoogleHttpClient;
    ...
    #@69
    .line 377
    .local v0, "client":Lcom/google/common/io/android/GoogleHttpClient;
    if-nez v0, :cond_3
    ...
    .line 381
    :cond_3
    invoke-virtual {v0}, Lcom/google/common/io/android/GoogleHttpClient;->getConnectionManager()Lorg/apache/http/conn/ClientConnectionManager;
    ...
    #@8c
    .line 357
    .end local v0    # "client":Lcom/google/common/io/android/GoogleHttpClient;
    .end local v2    # "factory":Lcom/google/common/io/android/AndroidHttpConnectionFactory;
