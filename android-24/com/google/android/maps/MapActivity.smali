...
# instance fields
.field private mConfig:Lcom/google/common/android/AndroidConfig;

.field private mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;
...
.field private mTrafficService:Lcom/google/googlenav/map/TrafficService;


# direct methods
.method static synthetic -get0(Lcom/google/android/maps/MapActivity;)Lcom/google/common/android/AndroidConfig;
    .locals 1

    #@0
    iget-object v0, p0, Lcom/google/android/maps/MapActivity;->mConfig:Lcom/google/common/android/AndroidConfig;

    #@2
    return-object v0
.end method

.method static synthetic -get1(Lcom/google/android/maps/MapActivity;)Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    .locals 1

    #@0
    iget-object v0, p0, Lcom/google/android/maps/MapActivity;->mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;
...
.method public constructor <init>()V
    ...
    #@4
    iput-object v0, p0, Lcom/google/android/maps/MapActivity;->mMap:Lcom/google/googlenav/map/Map;
...
.method private createMap()V
    ...
    #@4
    iput-object v0, p0, Lcom/google/android/maps/MapActivity;->mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    #@19
    iget-object v2, p0, Lcom/google/android/maps/MapActivity;->mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    #@28
    invoke-virtual {v0}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->resetConnectionFactory()V
    ...
    #@39
    invoke-virtual {v0, v10}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->setAndroidSignature(Ljava/lang/String;)V
    ...
    #@46
    invoke-virtual {v0, v1}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->setApplicationName(Ljava/lang/String;)V
    ...
    #@4a
    .line 561
    .local v4, "startPoint":Lcom/google/map/MapPoint;
    const/4 v5, 0x0

    #@4b
    .line 564
    .local v5, "zoom":Lcom/google/map/Zoom;
    ...
    new-instance v4, Lcom/google/map/MapPoint;

    #@57
    .end local v4    # "startPoint":Lcom/google/map/MapPoint;
    const/4 v0, 0x0
    ...
    #@5d
    invoke-direct {v4, v0, v1}, Lcom/google/map/MapPoint;-><init>(II)V
    ...
    #@77
    check-cast v0, Lcom/google/googlenav/map/Map;
    ...
    #@7b
    .line 572
    iget-object v0, p0, Lcom/google/android/maps/MapActivity;->mMap:Lcom/google/googlenav/map/Map;
    ...
    #@7f
    .line 573
    new-instance v0, Lcom/google/googlenav/map/Map;
    ...
    #@88
    .line 573
    invoke-direct/range {v0 .. v6}, Lcom/google/googlenav/map/Map;-><init>(IIILcom/google/map/MapPoint;Lcom/google/map/Zoom;I)V
    ...
    #@8f
    iget-object v1, p0, Lcom/google/android/maps/MapActivity;->mMap:Lcom/google/googlenav/map/Map;
    ...
    #@9d
    .line 586
    new-instance v0, Lcom/google/googlenav/map/TrafficService;
    ...
    #@a6
    invoke-direct {v0, v2, v3, v1}, Lcom/google/googlenav/map/TrafficService;-><init>(JLcom/google/common/task/TaskRunner;)V

    #@a9
    iput-object v0, p0, Lcom/google/android/maps/MapActivity;->mTrafficService:Lcom/google/googlenav/map/TrafficService;
    ...
    .line 535
    .end local v4    # "startPoint":Lcom/google/map/MapPoint;
    .end local v5    # "zoom":Lcom/google/map/Zoom;
    ...
    #@132
    .line 550
    invoke-static {v9, v8, v13, v7, v0}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->createInstance(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lcom/google/googlenav/datarequest/DataRequestDispatcher;
    ...
    .restart local v4    # "startPoint":Lcom/google/map/MapPoint;
    .restart local v5    # "zoom":Lcom/google/map/Zoom;
...
.method private restoreGlobalState()V
    ...
    #@10
    iget-object v1, p0, Lcom/google/android/maps/MapActivity;->mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;

    #@12
    invoke-virtual {v0, v1}, Lcom/google/android/maps/MapView;->restoreMapReferences(Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
...
.method private sendStartSession()V
    ...
    #@31
    .line 659
    invoke-virtual {v4, v6, v5, v7, v8}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->addSimpleRequest(I[BZZ)V
    :try_end_0
...
.method private setupTileDensity()V
    ...
    #@f
    invoke-static {v0}, Lcom/google/googlenav/map/MapTile;->setTextSize(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    #@14
    invoke-direct {v0, p0}, Lcom/google/common/android/AndroidConfig;-><init>(Landroid/content/Context;)V

    #@17
    iput-object v0, p0, Lcom/google/android/maps/MapActivity;->mConfig:Lcom/google/common/android/AndroidConfig;
    ...
    #@1b
    invoke-virtual {v0}, Lcom/google/common/android/AndroidConfig;->getImageFactory()Lcom/google/common/graphics/android/AndroidImageFactory;
    ...
    #@21
    invoke-virtual {v0, v1}, Lcom/google/common/graphics/android/AndroidImageFactory;->setStringIdMap(Ljava/util/Map;)V
...
.method protected onDestroy()V
    ...
    #@c
    invoke-virtual {v0, v1}, Lcom/google/android/maps/MapView;->cleanupMapReferences(Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
    ...
    #@20
    .line 504
    iget-object v0, p0, Lcom/google/android/maps/MapActivity;->mTrafficService:Lcom/google/googlenav/map/TrafficService;

    #@22
    invoke-virtual {v0}, Lcom/google/googlenav/map/TrafficService;->close()V
    ...
    #@28
    invoke-virtual {v0, v1}, Lcom/google/googlenav/map/Map;->close(Z)V
    ...
    #@2d
    invoke-virtual {v0}, Lcom/google/common/android/AndroidConfig;->getConnectionFactory()Lcom/google/common/io/android/AndroidHttpConnectionFactory;

    #@30
    move-result-object v0

    #@31
    invoke-virtual {v0}, Lcom/google/common/io/android/AndroidHttpConnectionFactory;->close()V
...
.method protected onPause()V
    ...
    #@d
    invoke-virtual {v0}, Lcom/google/googlenav/map/TrafficService;->stop()V
    ...
    #@12
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->pause()V
    ...
    #@21
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->saveState()V
    ...
    #@26
    invoke-virtual {v0}, Lcom/google/common/android/AndroidConfig;->getPersistentStore()Lcom/google/common/io/PersistentStore;
...
.method protected onResume()V
    ...
    #@8
    invoke-virtual {v0}, Lcom/google/googlenav/map/TrafficService;->start()V
    ...
    #@d
    invoke-virtual {v0}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->start()V
    ...
    #@17
    invoke-virtual {v0}, Lcom/google/googlenav/map/Map;->resume()V
...
.method setupMapView(Lcom/google/android/maps/MapView;)V
    ...
    #@11
    invoke-virtual {v0, v1}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->setAndroidMapKey(Ljava/lang/String;)V
    ...
    #@21
    invoke-virtual {v0, v1}, Lcom/google/googlenav/datarequest/DataRequestDispatcher;->setAndroidLoggingId2(Ljava/lang/String;)V
    ...
    #@2a
    iget-object v2, p0, Lcom/google/android/maps/MapActivity;->mTrafficService:Lcom/google/googlenav/map/TrafficService;

    #@2c
    iget-object v3, p0, Lcom/google/android/maps/MapActivity;->mDataRequestDispatcher:Lcom/google/googlenav/datarequest/DataRequestDispatcher;

    #@2e
    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/maps/MapView;->setup(Lcom/google/googlenav/map/Map;Lcom/google/googlenav/map/TrafficService;Lcom/google/googlenav/datarequest/DataRequestDispatcher;)V
